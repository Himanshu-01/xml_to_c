				...
				* *********************************************************************/
				struct Scnr
				{
					...
					enum class Flags : __int16
					{
						CortanaHack = 0,
						AlwaysDrawSky = 1,
						DontStripPathfinding = 2,
						SymmetricMultiplayerMap = 3,
						QuickLoadingCinematicOnlyScenario = 4,
						CharactersUsePreviousMissionWeapons = 5,
						LightmapsSmoothPalettesWithNeighbors = 6,
						SnapToWhiteAtStart = 7,
					};
					Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x12
					PAD(0x8);//0x14
					...
					struct Scenery
					{
						...
						enum class PlacementFlags : __int32
						{
							NotAutomatically = 0,
							NotOnEasy = 1,
							NotOnNormal = 2,
							NotOnHard = 3,
							LockTypeToEnvObject = 4,
							LockTransformToEnvObject = 5,
							NeverPlaced = 6,
							LockNameToEnvObject = 7,
							CreateAtRest = 8,
						};
						Blam::Cache::DataTypes::Bitfield32<PlacementFlags> PlacementFlags;//0x4
						float PositionX;//0x8
						float PositionY;//0xC
						...
						float Scale;//0x20
						enum class TransformFlags : __int16
						{
							Mirrored = 0,
						};
						Blam::Cache::DataTypes::Bitfield16<TransformFlags> TransformFlags;//0x24
						enum class ManualBSPFlags : __int16
						{
							BSP0 = 0,
							BSP1 = 1,
							BSP2 = 2,
						...
						Blam::Cache::DataTypes::Bitfield16<ManualBSPFlags> ManualBSPFlags;//0x26
						...
						enum class ActiveChangeColors : __int32
						{
							Primary = 0,
							Secondary = 1,
							Tertiary = 2,
						...
						Blam::Cache::DataTypes::Bitfield32<ActiveChangeColors> ActiveChangeColors;//0x38
						PAD(0x10);//0x3C
						...
						enum class ValidMultiplayerGames : __int16
						{
							CaptureTheFlag = 0,
							Slayer = 1,
							Oddball = 2,
						...
						Blam::Cache::DataTypes::Bitfield16<ValidMultiplayerGames> ValidMultiplayerGames;//0x58
					...
					struct Bipeds
					{
						...
						enum class Flags : __int32
						{
							Dead = 0,
							Closed = 1,
							NotEnterableByPlayer = 2,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x50
					};
					...
					struct Equipment
					{
						...
						__int8 Unknown;//0x31
						__int16 EditorFolder;//0x32
						enum class EquipmentFlags : __int32
						{
							InitiallyAtRestDoesNotFall = 0,
							Bit1 = 1,
							DoesAccelerateMovesDueToExplosions = 2,
						};
						Blam::Cache::DataTypes::Bitfield32<EquipmentFlags> EquipmentFlags;//0x34
					};
					...
					struct DeviceGroups
					{
						...
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x24
					};
					...
					struct Machines
					{
						...
						enum class Flags : __int32
						{
							...
							CanChangeOnlyOnce = 2,
							PositionReversed = 3,
							NotUsableFromAnySide = 4,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x38
						enum class Flags : __int32
						{
							DoesNotOperateAutomatically = 0,
							OneSided = 1,
							NeverAppearsLocked = 2,
							OpenedByMeleeAttack = 3,
							OneSidedForPlayer = 4,
							DoesNotCloseAutomatically = 5,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x3C
						struct PathfindingReferences
						{
							__int16 BSPIndex;//0x0
							__int16 PathfindingObjectIndex;//0x2
					...
					struct LightVolumes
					{
						...
						Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x3E
						...
						enum class LightmapFlags : __int16
						{
							Bit0 = 0,
						};
						Blam::Cache::DataTypes::Bitfield16<LightmapFlags> LightmapFlags;//0x42
					...
					struct NetgameFlags
					{
						...
						Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x16
					...
					struct NetgameEquipment
					{
						...
						{
							Levitate = 0,
							DestroyExistingOnNewSpawn = 1,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x0
						enum class GameType1 : __int16
						{
							None = 0,
							CaptureTheFlag = 1,
						...
						Blam::Cache::DataTypes::tagRef Item / VehicleCollection;//0x58
						PAD(0x30);//0x60
					};
					...
					{
						enum class StartingGrenades : __int32
						{
							NoGrenades = 0,
							PlasmaGrenades = 1,
						};
						Blam::Cache::DataTypes::Bitfield32<StartingGrenades> StartingGrenades;//0x0
						enum class GameType1 : __int16
						{
							None = 0,
							CaptureTheFlag = 1,
					...
					struct Squads
					{
						...
						enum class Flags : __int32
						{
							Bit0 = 0,
							NeverSearch = 1,
							StartTimerImmediately = 2,
							NoTimerDelayForever = 3,
							MagicSightAfterTimer = 4,
							AutomaticMigration = 5,
							Bit6 = 6,
							RespawnEnabled = 7,
							Blind = 8,
							Deaf = 9,
							Braindead = 10,
							NUM_3DFiringPositions = 11,
							InitiallyPlaced = 12,
							UnitsNotEnterableByPlayer = 13,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x20
						...
						struct StartingLoctations
						{
							...
							{
								InitiallyAsleep = 0,
								InfectionFormExplode = 1,
								Bit2 = 2,
								AlwaysPlace = 3,
								InitiallyHidden = 4,
							};
							Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x1C
					...
					struct Zones
					{
						...
						struct FiringPositions
						{
							...
							Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0xE
						...
						{
							Blam::Cache::DataTypes::String32 Name;//0x0
							enum class AreaFlags : __int32
							{
								VehicleArea = 0,
								Perch = 1,
								ManualReferenceFrame = 2,
							};
							Blam::Cache::DataTypes::Bitfield32<AreaFlags> AreaFlags;//0x20
					...
					struct MissionScenes
					{
						...
						enum class Flags : __int32
						{
							SceneCanPlayMultipleTimes = 0,
							EnableCombatDialogue = 1,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x4
						struct TriggerConditions
						{
							...
							struct Triggers
							{
								enum class TriggerFlags : __int32
								{
									Not = 0,
								};
								Blam::Cache::DataTypes::Bitfield32<TriggerFlags> TriggerFlags;//0x0
					...
					struct ScriptingData
					{
						struct PointSets
						{
							...
							enum class Flags : __int32
							{
								ManualReferenceFrame = 0,
								TurretDeployment = 1,
							};
							Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x2C
						};
					...
					struct CutsceneCameraPoints
					{
						...
						Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x0
						enum class Type : __int16
						{
							Normal = 0,
					...
					struct StructureBSPs
					{
						...
						Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x3C
						__int16 Unknown;//0x3E
					...
					struct UnitSeatsMapping
					{
						...
						Blam::Cache::DataTypes::Bitfield32<Seats> Seats;//0x4
					};
					...
					struct ScriptExpressions
					{
						...
						__int16 ScriptIndex / FunctionIndex / ConstantTypeUnion;//0x2
						enum class Type : __int16
						{
							Unparsed = 0,
							SpecialForm = 1,
					...
					struct Orders
					{
						...
						enum class Flags : __int32
						{
							...
							DebugOn = 2,
							StrictAreaDef = 3,
							FollowClosestPlayer = 4,
							FollowSquad = 5,
							ActiveCamo = 6,
							SuppressCombatUntilEngaged = 7,
							InhibitVehicleUse = 8,
						};
						Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x24
						...
						{
							enum class SpecialMovement1 : __int32
							{
								Jump = 0,
								Climb = 1,
								Vault = 2,
							...
							Blam::Cache::DataTypes::Bitfield32<SpecialMovement1> SpecialMovement1;//0x0
						};
					...
					struct AITriggers
					{
						...
						enum class TriggerFlags : __int32
						{
							LatchOnWhenTriggered = 0,
						};
						Blam::Cache::DataTypes::Bitfield32<TriggerFlags> TriggerFlags;//0x20
						enum class CombinationRule : __int16
						{
							Or = 0,
							And = 1,
						...
						struct Conditions
						{
							...
							Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0x34
						};
					...
					struct BackgroundSoundPalette
					{
						...
						enum class ScaleFlags : __int32
						{
							OverrideDefaultScale = 0,
							UseAdjacentClusterAsPortalScale = 1,
							UseAdjacentClusterAsExteriorScale = 2,
							ScaleWithWeatherIntensity = 3,
						};
						Blam::Cache::DataTypes::Bitfield32<ScaleFlags> ScaleFlags;//0x48
					...
					struct SpawnData
					{
						...
						{
							Blam::Cache::DataTypes::StringID Name;//0x0
							enum class RelevantTeam : __int32
							{
								Red = 0,
								Blue = 1,
								Yellow = 2,
							...
							Blam::Cache::DataTypes::Bitfield32<RelevantTeam> RelevantTeam;//0x4
							enum class RelevantGames : __int32
							{
								Slayer = 0,
								Oddball = 1,
								KingOfTheHill = 2,
							...
							Blam::Cache::DataTypes::Bitfield32<RelevantGames> RelevantGames;//0x8
							enum class Flags : __int32
							{
								DisabledIfFlagHome = 0,
								DisabledIfFlagAway = 1,
								DisabledIfBombHome = 2,
								DisabledIfBombAway = 3,
							};
							Blam::Cache::DataTypes::Bitfield32<Flags> Flags;//0xC
					...
					struct AtmosphericFogPalette
					{
						...
						enum class CameraImmersionFlags : __int16
						{
							DisableAtmosphericFog = 0,
							DisableSecondaryFog = 1,
							DisablePlanarFog = 2,
							InvertPlanarFogPriorites = 3,
							DisableWater = 4,
						};
						Blam::Cache::DataTypes::Bitfield16<CameraImmersionFlags> CameraImmersionFlags;//0xF0
					...
					struct Flocks
					{
						...
						enum class Flags : __int16
						{
							HardBoundariesOnVolume = 0,
							FlockInitiallyStopped = 1,
						};
						Blam::Cache::DataTypes::Bitfield16<Flags> Flags;//0x6
