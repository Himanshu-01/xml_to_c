			...
			* *********************************************************************/
			struct matg
			{
				...
				struct SoundGlobals
				{
					...
					Blam::Cache::DataTypes::tagRefN SoundGestalt;//0x20
				};
				...
				struct RasterizerData
				{
					...
					struct Flags
					{
						unsigned char TintEdgeDensity : 1;
				...
				struct Materials
				{
					...
					struct Flags
					{
						unsigned char Flammable : 1;
						unsigned char Biomass : 1;
						unsigned char bit2 : 1;
						unsigned char bit3 : 1;
						unsigned char bit4 : 1;
						unsigned char bit5 : 1;
					...
					{
						unsigned char SoundSmall : 1;
						unsigned char SoundMedium : 1;
						unsigned char SoundLarge : 1;
						unsigned char SoundRolling : 1;
						unsigned char SoundGrinding : 1;
						unsigned char bit5 : 1;
						unsigned char bit6 : 1;
						unsigned char bit7 : 1;
						unsigned char bit8 : 1;
					...
					}SweetenerInheritanceFlags;
					TAG_BLOCK_SIZE_ASSERT(SweetenerInheritanceFlags, 0x4);
					//0xA8
