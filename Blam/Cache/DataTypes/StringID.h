...
namespace Blam
{
	namespace Cache
	{
		namespace DataTypes
		{
		#define Invalid (UINT32)0xFFFFFFFF;
		#define Empty (UINT32)0x0;
		#define MaxLength (UINT32)0xFF;
		#define MaxIndex (UINT32)0xFFFFFF;
			/*********************************************************************
			...
			**********************************************************************/
			struct StringID
			{
				...
				//*requires definition
				//*better not include such funcions
